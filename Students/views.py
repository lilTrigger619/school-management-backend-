...
from .serializers import (
    ...
    Student_account_serializer,
    C_user,
    Student_minimal_view_serializer,
    Prefect_serializer,
)
...
class Create_student_profile_view(APIView):
    ...
    def post(self, request):
        ...
        if _ser_data.is_valid():
            ...
            return Response(
                _ser_data.errors, status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )
...
class Detail_update_student_profile_view(APIView):
    ...
    def put(self, request, pk):
        ...
        if _ser.is_valid() and _acc_ser.is_valid():
            ...
            return Response(
                {"profile_error": _ser.errors, "account_error": _acc_ser.errors},
