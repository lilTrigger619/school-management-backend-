...
def photo_upload(instance, filename):
    return 'Student/{0} {1}/profile_image/{2}'.format(instance.first_name,
                                                      instance.last_name,
                                                      filename)
...
class Student(models.Model): 
    ...
    parent_marrital_status=models.CharField(choices=Marrital_status, blank=True, null=True, max_length=16)
...
class Prefect(models.Model):
    ...
    prefect_type = models.CharField(max_length=1, choices=prefect_type, null=True, blank=True)
